            ...
            <tbody className="divide-y divide-slate-800/50">
              {conductores?.map((c: any) => (
                <tr key={c.id} className="hover:bg-slate-800/50 transition-colors">
                  <td className="px-5 py-4 font-medium text-slate-300">{c.telegram_chat_id}</td>
                  ...
                  <td className="px-5 py-4 text-slate-400">{c.rol_operativo}</td>
                  <td className="px-5 py-4 text-slate-400">{c.vehiculo || 'No registrado'}</td>
                  <td className="px-5 py-4 text-right">
                    <div className="flex justify-end gap-2">
                      ...
                      <button className="p-1.5 bg-slate-800 hover:bg-rose-500/20 text-slate-400 hover:text-rose-400 rounded transition-colors" title="Suspender">
                        <UserX size={16} />
                      </button>
                    </div>
                  </td>
